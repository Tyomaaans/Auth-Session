...
func (h *UserHandler) GetActiveSessionsMyProfile(c *gin.Context) {
	userID := c.GetString("userID")
...
func (h *UserHandler) RevokeSessionMyProfile(c *gin.Context) {
	userID    := c.GetString("userID")
...
func (h *UserHandler) RevokeAllOtherSessionsMyProfile(c *gin.Context) {
	userID    := c.GetString("userID")
...
func (h *UserHandler) RevokeAllSessionsMyProfile(c *gin.Context) {
	userID := c.GetString("userID")
